...
from mylib_json import Config        # class Config is located in a file called mylib.py

conf = Config('pconfig.json')        # constructor opens and reads this file according to its format
